...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('amount', models.IntegerField(validators=[recipes.validators.min_ingredient_amount_validator], verbose_name='количество')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', recipes.fields.ModelsSlugField(error_messages={'unique': 'Тег с такой меткой уже существует.'}, max_length=200, null=True, unique=True, verbose_name='метка')),
            ],
            options={
                'verbose_name': 'тег',
